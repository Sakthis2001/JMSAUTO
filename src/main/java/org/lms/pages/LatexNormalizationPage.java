...
public class LatexNormalizationPage {
    ...
    String freshTickicon = "//*[text()='Fresh']//following::img[@alt='actions'][1]";
    String RevisesTickicon = "//*[text()='Revises']//following::img[@alt='actions'][1]";
    ...
    private String editor = "//*[@title='editor']";
    ...
    private String completefilecloseicon = "//h2[text()='JMS - File Saved']//following::span[text()='×']";
    ...
    private String normalizedfolder = "//*[text()='LaTeX Normalize Done!']//preceding::img[1]";
    ...
    private String automateradio = "//*[contains(text(), 'Automat')]";
    private String acceptall = "//button[text()='✔ Accept All']";

    private String queryicon = "//*[@title='query']";
    private String compilecomplete = "//h2[text()='JMS - LaTex Compilation']//following::div[text()='LaTeX Compilation Completed!']";
    //private String compilecomplete="//*[text()='JMS - LaTex Compilation']//following::div[text()='LaTeX Compilation Completed!']";
    private String compilecompletecloseicon = "//*[text()='JMS - LaTex Compilation']//following::span[text()='×']";
    private String latexerror = "//*[contains(text(),' LaTeX Error:')]";
    ...
    public void DoAddArticleWithoutFile(String journalacro, String articleid, String artname, String doinum, String workflow) throws InterruptedException {
    ...
    public String DoConstantAddArticle(String journalacro, String articleid, String artname, String doinum, String workflow) throws InterruptedException {
...
/*
    ...
    public Boolean CompleteArticleDirectVerify(String pmunmae, String pmupass, String journalacro, String articleid, String artname, String doinum, String workflow, String luname, String lupass, String ltlunmae, String ltupass, String luname1, String lupass1) throws InterruptedException {
        ...
        Locator latexinitial = page.locator(latexinitializedone);
        latexinitial.waitFor(new Locator.WaitForOptions()
    ...
    public boolean VerifyNormalizeMsg(String pmunmae, String pmupass, String journalacro, String articleid, String artname, String doinum, String workflow, String luname, String lupass, String ltlunmae, String ltupass, String luname1, String lupass1) throws InterruptedException {
        ...
        Thread.sleep(3000);
        page.locator("//img[@title='start']").click();
        Locator latexinit = page.locator(latexinitializedone);
        latexinit.waitFor(new Locator.WaitForOptions()
                .setState(WaitForSelectorState.VISIBLE)
                .setTimeout(10000));
        ...
        Thread.sleep(3000);
        page.locator(normalization).click();
        Locator normalizationload = page.locator(normalizatoncloseicon);

        normalizationload.waitFor(new Locator.WaitForOptions()
                .setState(WaitForSelectorState.VISIBLE)
                .setTimeout(300000));

        return page.locator(normalizatoncloseicon).isVisible();
    ...
    public Boolean VerifyLatexFlow(String pmunmae, String pmupass, String journalacro, String articleid, String artname, String doinum, String workflow, String luname, String lupass, String ltlunmae, String ltupass, String luname1, String lupass1, String preuname, String preupass) throws InterruptedException {
        String arttimeid = String.valueOf(System.currentTimeMillis());
        ...
        page.locator(compilefile).click();
        Locator compilecompleted = page.locator(compilecomplete);
        compilecompleted.waitFor(new Locator.WaitForOptions()
                .setState(WaitForSelectorState.VISIBLE)
                .setTimeout(300000));

        page.locator(compilecompletecloseicon).click();

        page.locator(automateradio).click();
        page.locator(acceptall).click();
        page.locator(slidemove).click();
        page.locator(savefile).click();
        page.locator(savefiletoastclose).click();
        page.locator(completefile).click();
        ...
        page.locator(selectall).click();
        page.locator(searchbar).fill(arttimeid);
        Locator article = page.locator("//*['" + arttimeid + "']");
        article.waitFor(new Locator.WaitForOptions()
                .setState(WaitForSelectorState.VISIBLE)
                .setTimeout(300000));
        return page.locator("//*['" + arttimeid + "']").isVisible();

    }


    public Boolean VerifyNormalizeAndRestart(String pmunmae, String pmupass, String journalacro, String articleid, String artname, String doinum, String workflow, String luname, String lupass, String ltlunmae, String ltupass, String luname1, String lupass1, String preuname, String preupass) throws InterruptedException {
        String arttimeid = String.valueOf(System.currentTimeMillis());
        ...
        Locator latexinitagain = page.locator(latexinitializedone);
        latexinitagain.waitFor(new Locator.WaitForOptions()
                .setState(WaitForSelectorState.VISIBLE)
                .setTimeout(300000));
        return page.locator(latexinitializedone).isVisible();

    }


    public List<Object> VerifyNormalizeAndRestartFreq(String pmunmae, String pmupass, String journalacro, String articleid, String artname, String doinum, String workflow, String luname, String lupass, String ltlunmae, String ltupass, String luname1, String lupass1, String preuname, String preupass) throws InterruptedException {
        String arttimeid = String.valueOf(System.currentTimeMillis());
        ...
        List<Object> lateinitnormalize = new ArrayList<>();
        Locator latexinitagain = page.locator(latexinitializedone);
        latexinitagain.waitFor(new Locator.WaitForOptions()
                .setState(WaitForSelectorState.VISIBLE)
                .setTimeout(300000));
        lateinitnormalize.add(page.locator(latexinitializedone).isVisible());


        page.locator(slidemove).click();
        Thread.sleep(3000);
        page.locator(normalization).click();
        Locator normalizationloadagain = page.locator(normalizatoncloseicon);

        normalizationloadagain.waitFor(new Locator.WaitForOptions()
                .setState(WaitForSelectorState.VISIBLE)
                .setTimeout(300000));


        page.locator(normalizatoncloseicon).click();
        lateinitnormalize.add(lateinitnormalize.add(page.locator(latexnormalizedone).isVisible()));
        System.out.println(lateinitnormalize);
        page.locator(normalizedfolder).hover();
        int filecount = page.locator("//*[text()='Choose File']//following::li").count();
        System.out.println(filecount);
        lateinitnormalize.add(filecount);


        return lateinitnormalize;

    }

    public Boolean IsErrorDisplayed(String pmunmae, String pmupass, String journalacro, String articleid, String artname, String doinum, String workflow, String luname, String lupass, String ltlunmae, String ltupass, String luname1, String lupass1, String preuname, String preupass) throws InterruptedException {
        String arttimeid = String.valueOf(System.currentTimeMillis());
        ...
        String doivalue = String.valueOf(doival);
        logoutlogin(pmunmae, pmupass);
        DoAddArticleWithoutFile(journalacro, arttimeid, artname, doivalue, workflow);
        fileChooser = page.waitForFileChooser(() -> page.locator(fileupload).click());
        ...
        page.locator(compilecompletecloseicon).click();
        int latexerrorcount = page.locator(latexerror).count();
        System.out.println(latexerrorcount);
        Boolean error;
        if (latexerrorcount > 0) {
            error = true;
        } else {
            error = false;
        }
    ...
    public List<Boolean> VerifyTickICon(String uname, String upass) {

        logoutlogin(uname, upass);
        page.keyboard().press("Enter");
        Boolean firstFrClick = page.locator(freshTickicon).isVisible();
        page.locator(freshTickicon).click();
        Boolean secondFrClick = page.locator(freshTickicon).isVisible();

        page.locator(RevisesTickicon).click();
        Boolean firstArclick = page.locator(RevisesTickicon).isVisible();
        page.locator(RevisesTickicon).click();
        Boolean secondArclick = page.locator(RevisesTickicon).isVisible();

        List<Boolean> isclickicon = new ArrayList<>();
        isclickicon.add(firstFrClick);
        isclickicon.add(secondFrClick);

        isclickicon.add(firstArclick);
        isclickicon.add(secondArclick);

        return isclickicon;



        /*int freshcount=page.locator("//tr").count();
        Boolean freshartcount;
        if(freshcount>0)
        {
            freshartcount=true;
        }
