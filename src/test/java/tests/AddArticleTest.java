...
public class AddArticleTest extends BaseTest {
   ...
   @Test(priority =1,dataProvider ="duplicatedata", description = "Upon providing valid inputs, Article can be added - need to be listed")
    ...
    public void AddArticleDuplication(String journalacro, String articleid, String artname, String doinum, String workflow) throws InterruptedException {
        ...
        Boolean errormessage = addarticlepage.ensureduplicationarticle(journalacro, articleid, artname, doinum, workflow);
        System.out.println(errormessage);
        Assert.assertTrue(errormessage, "article id duplicate alert is not showing ");
    }
  ...
  /*  @Test(priority = 5, dataProvider = "unauthoaccess", description = "Other than PM and Login should create the Add article ")
    ...
    @Test(priority = 7, dataProvider = "articletographics", description = "JMS:40-Article with no images should not move to Graphics Department-version 2")
    public void verifyarticleShoulntGoGraphics(String journalacro, String articleid, String artname, String doinum, String workflow, String uname, String upass, String displayfigcount, String Inlinefigcount) throws InterruptedException {
        ExtentReportListener.getTest().assignCategory(cateogry);
        ExtentReportListener.getTest().assignAuthor(authorname);
        ...
        Assert.assertFalse(IsarticleShowingInGraphics, "Article is not showing in the graphics");
...
//        softAssert.assertAll();
    ...
    @Test(priority = 13, dataProvider = "addarticlewithoutfile", description = "JMS-115 : All the files including ZIP, will have Download, Remove options-version 3")
    ...
    @Test(priority =28,dataProvider ="ModifiedTatdata",description ="JMS-36 : Modification of TAT after imported-version 2")
    public void verifyModifiedTat(String journalacro, String articleid, String artname, String doinum, String workflow,String pub,String jour,String f_latex,String f_gra,String f_pre,String f_copy,String f_pag,String f_qc,String au_pag,String au_qc,String pe_pag,String pe_qc,String onlinepag,String onlineqc,String onlinexml,String issuepag,String issueqc,String printpag,String printqc,String print_xml ) throws InterruptedException {
        ...
        int totalWorkingDays = 18;
        LocalDate resultDate = LocalDate.now();

        System.out.println("Start Date: " + resultDate);
        int addedDays = 0;
        ...
        List<String> articleFirstData= addarticlepage.ModifyTatAfterImport(journalacro, articleid, artname, doinum, workflow,pub,jour,f_latex,f_gra,f_pre,f_copy,au_pag,au_qc,pe_pag,pe_qc,onlinepag,onlineqc,onlinexml,issuepag,issueqc,printpag,printqc,print_xml);
        System.out.println(articleFirstData);

        Assert.assertEquals(articleFirstData.get(1),resultDate,"After Tat changed ,first proof due date not changed");

        ExtentReportListener.getTest().log(Status.INFO,"DUE ON dates are Modified and the Dates are updating successfully");

    }

    @Test(priority =29,dataProvider = "addarticledata",description =" JMS-34 : Verify the 'Due On' date is calculated-version 3" )
...
//MailPreview
    ...
    @Test(priority =32,dataProvider = "addarticledata",description ="JMS-100 : Ensure the selection of ‘Cc’ is optional - not mandatory - check on both -version 3" )
    public void VerifyCcMailNotMandatory(String journalacro, String articleid, String artname, String doinum, String workflow,String pub,String jour) throws InterruptedException
    {
        ...
        ExtentReportListener.getTest().log(Status.INFO,"Ensure that Mandatory Text Fields Are Filled");
        ExtentReportListener.getTest().log(Status.INFO,"Click Mail Preview Check Box");
        ExtentReportListener.getTest().log(Status.INFO,"click Acknowledgements mail and select to Address");
        ExtentReportListener.getTest().log(Status.INFO,"click  Notification Mail And Selecct to Address");
        ...
        ExtentReportListener.getTest().log(Status.INFO," CC mail is not Mandatory its optional");
   ...
   @Test(priority =53,dataProvider ="duplicatedata",description = "JMS-93 : Provide old/new DOI number for article and ensure it is indicated accordingly - Version 2")
    public void VerifyDoiAlert(String journalacro, String articleid, String artname, String doinum, String workflow) throws InterruptedException
    {
     ...
     Boolean isindicates= addarticlepage.AddArticleWithDuplicateDoi(journalacro,articleid,artname,doinum,workflow);

     Assert.assertFalse(isindicates,"doi alert is not showing");
   ...
   /* @Test(priority = 56,dataProvider = "notes",description = " JMS-196 : Toggle any checkboxes above for Tables,Figures - Version 1")
    ...
    @DataProvider(name = "genandfasttat")
    public Object[][] getallTatData() throws IOException
    {
        return ExcelReader.ReadExcelData(".//src//test//resources//files//AddArticle.xlsx", 21);
    }

   /* @Test(priority = 58, dataProvider = "genandfasttat", description = "JMS-33 : Toggle between General and FastTat - Version 2")
    public void VerifyGenAndFastTat(String journalacro, String articleid, String artname, String doinum, String workflow, String uname, String upass, String displayfigcount, String Inlinefigcount) throws InterruptedException {
        ExtentReportListener.getTest().assignCategory(cateogry);
        ExtentReportListener.getTest().assignAuthor(authorname);

         addarticlepage.verifyGenAndFastTrack(journalacro, articleid, artname, doinum, workflow);

    }*/



    @Test(priority =58,dataProvider ="duplicatedata",description = "JMS-92 : DOI number and ensure it is indicated accordingly and further article can be added -version 2")
    public void VerifyArticleAddedwhileDoiAlert(String journalacro, String articleid, String artname, String doinum, String workflow) throws InterruptedException
    {
        ExtentReportListener.getTest().assignCategory(cateogry);
        ExtentReportListener.getTest().assignAuthor(authorname);
       ...
       Boolean isadded=addarticlepage.CanAddArticleWithDoi(journalacro,articleid,artname,doinum,workflow);
