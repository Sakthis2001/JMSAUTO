...
*//*
    ...
    @DataProvider(name = "ytshold")
    public Object[][] availableytshold() throws IOException {
        return ExcelReader.ReadExcelData(".//src//test//resources//files//LatexNormalization.xlsx",7);
    }

    @DataProvider(name = "addarticle")
    public Object[][] getarticle() throws IOException {
        return ExcelReader.ReadExcelData(".//src//test//resources//files//LatexNormalization.xlsx",12);
    }

    @DataProvider(name = "workflow")
    public Object[][] getworkflow() throws IOException{
        return ExcelReader.ReadExcelData(".//src//test//resources//files//LatexNormalization.xlsx",11);
    }

    @Test(priority =0,dataProvider="addarticle")
    public void DoAddArticle(String journalacro,String arttimeid,String artname,String doivalue,String workflow) throws InterruptedException {
        latexNormalizationPage.DoConstantAddArticle(journalacro, arttimeid, artname, doivalue, workflow);
    }



    @Test(priority =1,description = "JMS-223 : Add article and verify the Cards - Version 1",dataProvider = "ytshold")
    ...
    @Test(priority =2,description = " JMS-224 : Complete article and Check count - Version 1",dataProvider = "ytshold")
    ...
    @Test(priority =3,description =" JMS-291 : Skipping of any mandatory process - should be prevented - Version 1",dataProvider = "ytshold")
    ...
    @Test(priority =4,description =" JMS-292 : Generation of new Tex file after Normalise - Version 1",dataProvider = "ytshold")
    ...
    @Test(priority =5,description ="JMS-290 : General Flow - Version 1",dataProvider = "workflow")
    public void VerifyGeneralFlow(String pmunmae,String pmupass,String journalacro, String articleid, String artname, String doinum, String workflow,String luname,String lupass,String ltlunmae,String ltupass,String luname1,String lupass1,String preuname,String preupass) throws InterruptedException {
        Boolean isvisible=latexNormalizationPage.VerifyLatexFlow(pmunmae,pmupass,journalacro,articleid,artname,doinum,workflow,luname,lupass,ltlunmae,ltupass,luname1,lupass1,preuname,preupass);
         Assert.assertFalse(isvisible,"Still article exist in Latex");
    }

/*    @Test(priority =6,description =" JMS-294 : Normalise and Restart again - Version 1 ",dataProvider = "workflow")
    public void VerifyNormalizeThenRestart(String pmunmae,String pmupass,String journalacro, String articleid, String artname, String doinum, String workflow,String luname,String lupass,String ltlunmae,String ltupass,String luname1,String lupass1,String preuname,String preupass) throws InterruptedException {
        Boolean isvisible=latexNormalizationPage.VerifyNormalizeAndRestart(pmunmae,pmupass,journalacro,articleid,artname,doinum,workflow,luname,lupass,ltlunmae,ltupass,luname1,lupass1,preuname,preupass);
        Assert.assertTrue(isvisible,"Latex initial done is not visible");
    }*/

    @Test(priority =6,description ="JMS-294 : Normalise and Restart again - Version 1",dataProvider = "workflow")
    public void VerifyNormalizeThenRestartfrequently(String pmunmae,String pmupass,String journalacro, String articleid, String artname, String doinum, String workflow,String luname,String lupass,String ltlunmae,String ltupass,String luname1,String lupass1,String preuname,String preupass) throws InterruptedException {
        List<Object> isvisible=latexNormalizationPage.VerifyNormalizeAndRestartFreq(pmunmae,pmupass,journalacro,articleid,artname,doinum,workflow,luname,lupass,ltlunmae,ltupass,luname1,lupass1,preuname,preupass);
        System.out.println(isvisible);
        SoftAssert softAssert=new SoftAssert();
        softAssert.assertTrue((Boolean) isvisible.get(0),"Latex initial done is not visible");
        softAssert.assertTrue((Boolean) isvisible.get(1),"Latex normalize done is not visible");
        softAssert.assertEquals( isvisible.get(2),"2","After normalized file count  should 2");
        softAssert.assertAll();
    }

    @Test(priority =7,description ="JMS-297 : Verify errors are being generated - Version 1",dataProvider = "workflow")
    public void VerifyErrorDisplayed(String pmunmae,String pmupass,String journalacro, String articleid, String artname, String doinum, String workflow,String luname,String lupass,String ltlunmae,String ltupass,String luname1,String lupass1,String preuname,String preupass) throws InterruptedException {
       boolean error=latexNormalizationPage.IsErrorDisplayed(pmunmae,pmupass,journalacro,articleid,artname,doinum,workflow,luname,lupass,ltlunmae,ltupass,luname1,lupass1,preuname,preupass);
       Assert.assertTrue(error,"Error is not displayed");
    }

    @Test(priority =8,description = "JMS-225 : Toggle between the cards - Version 1")
    public void SelectFreshAndRevises()
    {
        String luname=prop.getProperty("latexusername");
        String lupass=prop.getProperty("latexuserpassword");
        List<Boolean> istickvisible=latexNormalizationPage.VerifyTickICon(luname,lupass);
        SoftAssert softAssert=new SoftAssert();

        softAssert.assertTrue(istickvisible.get(0),"FreshTick is not showing");
        softAssert.assertTrue(istickvisible.get(1),"Fresh Ticon is  showing");
        softAssert.assertTrue(istickvisible.get(2),"AR Ticon is  showing");
        softAssert.assertTrue(istickvisible.get(3),"AR Ticon is not showing");
        softAssert.assertAll();
